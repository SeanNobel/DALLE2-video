    ...
    def forward(
        ...
        *,
        ...
        Args:
            ...
            image_embed (_type_): _description_
            lowres_cond_img (_type_, optional): _description_. Defaults to None.
            ...
            image_cond_drop_prob (float, optional): _description_. Defaults to 0.0.
        ...
        x = self.init_conv(x)  # ( b, c=128, h, w )
        cprint(x.shape, "cyan")
        ...
        image_keep_mask = prob_mask_like(
            (batch_size,), 1 - image_cond_drop_prob, device=device
        )
...
class LowresConditioner(nn.Module):
    ...
    def forward(
        ...
        *,
        ...
        cond_fmap = resize_image_to(
            cond_fmap, target_image_size, clamp_range=self.input_image_range, nearest=True
        )
...
class DALLE2(nn.Module):
    ...
    @eval_decorator
    def forward(
        self, text, cond_scale=1.0, prior_cond_scale=1.0, return_pil_images=False
    ):
        ...
        images = self.decoder.sample(
            image_embed=image_embed, text=text_cond, cond_scale=cond_scale
        )
